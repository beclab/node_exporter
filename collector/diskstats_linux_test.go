...
node_disk_info{bus="",device="dm-0",external="0",major="252",minor="0",model="",path="",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="dm-1",external="0",major="252",minor="1",model="",path="",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="dm-2",external="0",major="252",minor="2",model="",path="",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="dm-3",external="0",major="252",minor="3",model="",path="",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="dm-4",external="0",major="252",minor="4",model="",path="",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="dm-5",external="0",major="252",minor="5",model="",path="",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="mmcblk0",external="0",major="179",minor="0",model="",path="platform-df2969f3.mmc",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="mmcblk0p1",external="0",major="179",minor="1",model="",path="platform-df2969f3.mmc",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="mmcblk0p2",external="0",major="179",minor="2",model="",path="platform-df2969f3.mmc",removable="",revision="",rotational="0",serial="",wwn=""} 1
node_disk_info{bus="",device="nvme0n1",external="0",major="259",minor="0",model="SAMSUNG EHFTF55LURSY-000Y9",path="pci-0000:02:00.0-nvme-1",removable="",revision="4NBTUY95",rotational="0",serial="S252B6CU1HG3M1",wwn="eui.p3vbbiejx5aae2r3"} 1
node_disk_info{bus="ata",device="sda",external="0",major="8",minor="0",model="TOSHIBA_KSDB4U86",path="pci-0000:3b:00.0-sas-phy7-lun-0",removable="",revision="0102",rotational="1",serial="2160A0D5FVGG",wwn="0x7c72382b8de36a64"} 1
node_disk_info{bus="ata",device="sdb",external="0",major="8",minor="16",model="SuperMicro_SSD",path="pci-0000:00:1f.2-ata-1",removable="",revision="0R",rotational="0",serial="SMC0E1B87ABBB16BD84E",wwn="0xe1b87abbb16bd84e"} 1
node_disk_info{bus="ata",device="sdc",external="0",major="8",minor="32",model="INTEL_SSDS9X9SI0",path="pci-0000:00:1f.2-ata-4",removable="",revision="0100",rotational="0",serial="3EWB5Y25CWQWA7EH1U",wwn="0x58907ddc573a5de"} 1
node_disk_info{bus="usb",device="sr0",external="1",major="11",minor="0",model="Virtual_CDROM0",path="pci-0000:00:14.0-usb-0:1.1:1.0-scsi-0:0:0:0",removable="",revision="1.00",rotational="0",serial="AAAABBBBCCCC1",wwn=""} 1
node_disk_info{bus="",device="vda",external="0",major="254",minor="0",model="",path="pci-0000:00:06.0",removable="",revision="",rotational="0",serial="",wwn=""} 1
